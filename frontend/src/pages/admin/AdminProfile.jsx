          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <MiniCard title="Restaurants" value={statsLoading ? "…" : (stats?.totalRestaurants ?? "—")} icon={<Store size={18}/>} color="from-green-500 to-green-400"  />
                <MiniCard title="Drivers"     value={statsLoading ? "…" : (stats?.totalDrivers     ?? "—")} icon={<Bike  size={18}/>} color="from-purple-500 to-purple-400"/>
                <MiniCard title="Users"       value={statsLoading ? "…" : (stats?.totalUsers       ?? "—")} icon={<Users size={18}/>} color="from-blue-500 to-blue-400"   />
              </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-7 relative">
        ...
        <div className="flex justify-end gap-3 mt-6">
          <button onClick={onClose} className="px-4 py-2 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 text-sm">
            Cancel
          </button>
          <button
