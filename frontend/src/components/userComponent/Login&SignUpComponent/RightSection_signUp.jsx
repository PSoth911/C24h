...
const RightSection_signUp = () => {
    ...
    return (
        <div className="left-section flex flex-col justify-center px-32">
            ...
            <div className="login-form flex flex-col gap-4">
                ...
                <div className="signup-link flex justify-center mt-2">
                    <p className="text-gray-600 justify-center">Already have an account? <span onClick={()=>navigate(PATH.USER.LOGIN)} className="text-[#004953] cursor-pointer">Log in</span></p>
                </div>
            </div>
        </div>
    );
